...
#define SWITCH _RA1
#define SWITCH_TRIS _TRISA1

#define LED_RED _LATB2
#define LED_RED_TRIS _TRISB2

#define LED_YELLOW _LATB1
#define LED_YELLOW_TRIS _TRISB1

#define LED_GREEN _LATB0
#define LED_GREEN_TRIS _TRISB0
